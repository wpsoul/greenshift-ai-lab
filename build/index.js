...
/***/ "./src/blocks/customhtml/attributes.js":
/*!*********************************************!*\
  !*** ./src/blocks/customhtml/attributes.js ***!
  \*********************************************/
...
/* harmony import */ var _preview__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./preview */ "./src/blocks/customhtml/preview.js");
/* harmony import */ var _components_gspbcode__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../components/gspbcode */ "./src/components/gspbcode.js");
...
function edit(props) {
  ...
  const [codeMode, setCodeMode] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)('html');
  const [collapseMode, setCollapseMode] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  let DefaultStyle = {
    maxHeight: 40,
    overflow: 'auto'
  };
  const [collapseStyle, setCollapseStyle] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(DefaultStyle);
  const targetCoderef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  ...
  }, "HTML"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarButton, {
    className: "components-tab-button",
    isPressed: codeMode === 'css' ? true : false,
    onClick: () => setCodeMode('css')
  }, "CSS"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarButton, {
    className: "components-tab-button",
    isPressed: codeMode === 'script' ? true : false,
    onClick: () => setCodeMode('script')
  }, "SCRIPT"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarButton, {
    className: "components-tab-button",
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Preview'))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarGroup, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarButton, {
    className: "components-tab-button",
    isPressed: collapseMode,
    onClick: () => setCollapseMode(!collapseMode)
  }, "Collapse"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "gspb_codeinner",
    ref: targetCoderef,
    style: collapseStyle
  }, codeMode === 'preview' ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_preview__WEBPACK_IMPORTED_MODULE_4__["default"], {
    content: htmlcontent,
    blockStyle: [csscontent],
    blockScript: scriptcontent,
    isSelected: isSelected
  }) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_gspbcode__WEBPACK_IMPORTED_MODULE_5__["default"], {
...
/***/ "./src/blocks/customhtml/index.js":
/*!****************************************!*\
  !*** ./src/blocks/customhtml/index.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _styles_editor_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.editor.scss */ "./src/blocks/customhtml/styles.editor.scss");
/* harmony import */ var _customhtml_attributes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../customhtml/attributes */ "./src/blocks/customhtml/attributes.js");
/* harmony import */ var _edit_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit.js */ "./src/blocks/customhtml/edit.js");
/* harmony import */ var _customhtml_icon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../customhtml/icon */ "./src/blocks/customhtml/icon.js");
/**
 * Icon box Block
 */
...
registerBlockType('greenshift-blocks/customhtml', {
  ...
  icon: _customhtml_icon__WEBPACK_IMPORTED_MODULE_3__["default"],
  category: 'greenShiftAi',
  keywords: [__('code'), __('AI'), __('scripts')],
  // Define attributes
  attributes: _customhtml_attributes__WEBPACK_IMPORTED_MODULE_1__["default"],
...
/***/ "./src/blocks/customhtml/preview.js":
/*!******************************************!*\
  !*** ./src/blocks/customhtml/preview.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ HTMLEditPreview)
/* harmony export */ });
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
...
function HTMLEditPreview(_ref) {
  ...
  const settingStyles = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
    return select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.store).getSettings()?.styles;
  }, []);
  const styles = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => [DEFAULT_STYLES, ...blockStyle, ...(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.transformStyles)(settingStyles)], [settingStyles]);
  const blob = new Blob([blockScript], {
    type: 'application/javascript'
  });
  const scriptsUrl = [URL.createObjectURL(blob)];
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SandBox, {
    html: content,
    styles: styles,
    scripts: scriptsUrl,
    type: "embed"
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Gspbcode)
/* harmony export */ });
...
/* harmony import */ var prism_react_renderer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! prism-react-renderer */ "./node_modules/prism-react-renderer/dist/index.mjs");
/* harmony import */ var _styles_editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./styles.editor.scss */ "./src/components/styles.editor.scss");
...
function Gspbcode(props) {
  ...
  const CodeSyntextGenerator = _ref => {
    let {
      className,
      style,
      tokens,
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("pre", {
      style: style
    }, tokens.map((line, i) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
      key: i
    }, getLineProps({
      line
    })), line.map((token, key) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("span", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
      key: key
    }, getTokenProps({
      token
    })))))));
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(prism_react_renderer__WEBPACK_IMPORTED_MODULE_4__.Highlight, {
    code: code,
    language: langauge
  }, (className, style, tokens, getLineProps, getTokenProps) => CodeSyntextGenerator(className, style, tokens, getLineProps, getTokenProps)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.PlainText, {
    onChange: codeHanler,
    value: code,
    className: "gspb_code_textarea",
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Write Here…'),
    "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)(langauge),
    ref: textAreaRef
  }));
}
...
/***/ "./src/blocks/customhtml/styles.editor.scss":
/*!**************************************************!*\
  !*** ./src/blocks/customhtml/styles.editor.scss ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/components/styles.editor.scss":
/*!*******************************************!*\
  !*** ./src/components/styles.editor.scss ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// src/index.ts
var Highlight2 = (props) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Highlight, __spreadValues({
  prism: Prism,
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _blocks_customhtml__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blocks/customhtml */ "./src/blocks/customhtml/index.js");
/**
 * Gutenberg Blocks
 *
